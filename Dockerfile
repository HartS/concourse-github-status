...
RUN cd /usr/lib/ruby/gems/2.5.0/gems && rm -rf concourse-github-status-0.6.6/ && git clone --branch develop https://github.com/harts/concourse-github-status.git concourse-github-status-0.6.6/
